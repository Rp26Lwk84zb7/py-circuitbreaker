...
> Design notes for **py-circuitbreaker** — a runnable python example that A minimal closed/open/half-open circuit breaker — clock injected, no deps.
...
- **Feature code** — the actual task: circuitbreaker.
